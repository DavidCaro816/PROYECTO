...
create view view_cotizacion as
    ...
    from cotizacion
        ...
        inner join aseguradoracotizante a on cotizacion.id_cotizacion = a.cotizacion
...
create view view_reporte as
    select idReporte as `No. Reporte`,fecha as Fecha,titulo as Nombre,archivo as `Reporte`,usuario as `Generado por`
    from reporte
