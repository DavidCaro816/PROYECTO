    ...
    echo '<header class="header">
            ...
            <div class="group-2">
                ...
                <section class="notifications">
                    ...
                    <div class="modal notifications_modal">
                ...
                <section class="profile">
                    <img id="profile" class="icon_profile" src="../icons/buttons/profile.svg" alt="Perfil">
                    <div class="modal profile_modal">
                        <a>
