...
<?php while($filas = mysqli_fetch_array($resultado)){
    ?>
            ...
            <div class="campoDireccionTrabajo">
                <input type="text" name="direccionTrabajo" placeholder="Dirección trabajo" required>
            </div>
            ...
            <div class="campoNumeroTelefono2">
                <input type="text" name="numeroTelefono2" placeholder="No. Teléfono 2" required>
            </div>
            ...
            <div class="campoTipoCliente">
                <select name="tipoCliente" required>
                    ...
                    while($datosTipoCliente = mysqli_fetch_array($consultaTipoCliente)){
                        ?>
                        <option value="<?php echo $datosTipoCliente['TipoCliente'] ?>"><?php echo $datosTipoCliente['tipoCliente'];?></option>
                        <?php
                    }
                    ?>
