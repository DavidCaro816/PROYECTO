        ...
        <div class="navbar">
            <div class="navbar_group">
                <div class="navbar_header">
                    <div class="logo">
                        <img src="../LOGIN/icons/logo.svg" alt="">
                    </div>
                </div>
                <div class="navbar_body">
                    ...
                    <div class="clients">
                        <a href=""><img src="../LOGIN/icons/clients.svg" alt=""></a>
                    </div>
                    <div class="quotes">
                        <a href=""><img src="../LOGIN/icons/quotes.svg" alt=""></a>
                    </div>
                    <div class="policies">
                        <a href=""><img src="../LOGIN/icons/policies.svg" alt=""></a>
                    </div>
                    <div class="sinister">
                        <a href=""><img src="../LOGIN/icons/sinister.svg" alt=""></a>
                    </div>
                    <div class="reports">
        ...
        <div class="container_boxes">
            ...
            <div class="recents">
                ...
                <div class="body_recents">
                    ...
                    <div class="recents_data">
                        <?php echo '<p>1</p>';echo'<p>2</p>';echo'<p>3</p>'; echo'<p>4</p>';?>
                        <?php echo '<p>1sasdsd2</p>';echo'<p>2e</p>';echo'<p>13213</p>'; echo'<p>114</p>';?>
                    </div>
                </div>
            </div>
